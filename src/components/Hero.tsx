    ...
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Клуб хобби-встреч · Москва"}</p>

          <h1
            ref={titleRef}
            className="text-7xl font-medium text-balance text-white mb-0 tracking-tight leading-[0.9] lg:text-8xl mx-[147px] text-right"
          >
            {"Место, где люди"}
            <br />
            <span className="text-orange-200">{"находят своих"}</span>
          </h1>
        </div>
      </div>
